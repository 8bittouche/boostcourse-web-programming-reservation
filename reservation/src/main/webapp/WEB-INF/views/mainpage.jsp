...
<body>
    ...
    <script type="text/x-handlebars-template" id="promotionItem">
    	<li class="item" style="background-image: url(download/{{productImageUrl}});">
    ...
    <script type="text/x-handlebars-template" id="itemList">
        <li class="item">
            <a href="detail?id={{displayInfoId}}" class="item_book">
                <div class="item_preview">
                    <img alt="{{productDescription}}" class="img_thumb" src="download/{{productImageUrl}}">
    ...
    <script type="text/x-handlebars-template" id="categoryTab">
