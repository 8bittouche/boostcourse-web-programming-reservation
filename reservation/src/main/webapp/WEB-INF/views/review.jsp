                ...
                <div class="section_review_list">
                    ...
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area"> <span class="graph_mask"> <em class="graph_value" ></em> </span> <strong class="text_value"> <span></span> <em class="total">5.0</em> </strong> <span class="join_count"><em class="green"></em> 등록</span>                                </div>
	...
	<li class="list_item">
        ...
        <div class="review_area">
			<div class="thumb_area">
            	<a class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="download/{{reservationUserCommentImageId}}" alt="리뷰이미지"> </a> <span class="img_count">{{commentImageCount}}</span>
			</div>
            <h4 class="resoc_name">{{productDescription}}</h4>
            <p class="review">{{comment}}</p>
        </div>
