				...
				<h1 class="logo">
				  ...
				  <c:choose>
                	<c:when test="${sessionScope.reservationEmail != null}">
                		<a href="myreservation" class="btn_my"> <span class="viewReservation" title="예약확인">${sessionScope.reservationEmail }</span> </a>
                	</c:when>
                	<c:otherwise>
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="myreservation?reservationEmail=${sessionScope.reservationEmail }" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
					<h2><span class="title">${param.title}</span></h2>
					<input type="hidden" id="reservationEmail" value=${sessionScope.reservationEmail }>
					<input type="hidden" id="reservationInfoId" value=${param.reservationInfoId }>
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="file" class="hidden_input" id="reviewImageFileOpenInput" accept="image/*">
						...
						<div class="item_preview_thumbs">
							<ul class="lst_thumb">
								<li class="item" style="display: none;">
									...
									<img src="" width="130" alt="리뷰 포토" class="item_thumb">
