                ...
                <div class="section_visual">
                    ...
                    <div class="group_visual">
                        <div>
                            ...
                            <div class="nxt" style="display: none">
                                <div class="nxt_inn">
                            ...
                            <div class="store_info">
                                ...
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="" class="store_tel"></a></span> </li>
                                    </ul>
                                </div>
                            </div>
...
<script type="text/x-handlebars-template" id="detail_background_img">
    <li class="item" style="width:100%; height:100%"><img alt="배경영역 사진" class="img_thumb" src="download/{{saveFileName}}"><span class="img_bg"></span>
...
<script type="text/x-handlebars-template" id="review_list_item_no_img">
	<li class="list_item">
   	 <div>
...
<script type="text/x-handlebars-template" id="review_list_item">
	<li class="list_item">
   	 <div>
        <div class="review_area">
			<div class="thumb_area">
            	<a class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="download/{{commentImageSaveFileName}}" alt="리뷰이미지"> </a> <span class="img_count">{{commentImageCount}}</span>
			</div>
            <h4 class="resoc_name"></h4>
            <p class="review">{{comment}}</p>
        </div>
